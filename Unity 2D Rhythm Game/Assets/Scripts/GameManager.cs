...
public class GameManager : MonoBehaviour
{
    ...
    void MusicStart()
    {
        ...
        audioSource.Play();
        AudioClip vocalClip = Resources.Load<AudioClip>("Vocals/" + PlayerInformation.selectedMusic);
        vocalSource = GameObject.Find("Vocal").GetComponent<AudioSource>();
    ...
    public void processJudge(judges judge, int noteType)
    {
        ...
        if(judge == judges.MISS)
        {
            ...
            combo = 0;
            if (isvocalStop == false)
                StartCoroutine(VocalStop());
